...
class Fonts:
    UI   = "Segoe UI, Microsoft YaHei"  # 레이블·버튼·체크박스
    MONO = "Consolas, Courier New"      # 수치·로그·스핀박스 값 (DirectWrite 호환성)
...
class Sizes:
    TITLE = "21px"   # 탭/패널 제목
    BTN = "19px"   # 주요 버튼
    CTRL = "18px"   # 컨트롤 레이블·스핀박스·콤보
    LOG = "17px"   # 로그·테이블 텍스트
    SMALL = "16px"   # 보조 레이블·상태바 힌트
