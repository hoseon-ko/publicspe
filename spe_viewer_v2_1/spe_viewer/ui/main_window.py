...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.dock_files.setMinimumWidth(180)
        ...
        self.dock_frames.setMinimumWidth(220)
        self.addDockWidget(Qt.DockWidgetArea.RightDockWidgetArea, self.dock_frames)
